...
public class UserCreation {
    ...
    public UserCreation(String userId, String serviceId, String login, String firstName, String name,
                        String mail, String phone, String status, String role, String access, String codetype,
                        String language, String extrafields) {
        this.userId = userId;
    ...
    private static SOAPMessage createUser() throws SOAPException, IdentityProvisioningException {
        ...
        soapBodyElem12.addTextNode(UserCreation.language);
        SOAPElement soapBodyElem13 = soapBodyElem.addChildElement("extrafields", "con");
        soapBodyElem13.addTextNode(UserCreation.extrafields);
